...
return [
    ...
    'description' => 'WeWinGames Sports Betting API provides endpoints for managing bets, games, users, and sports data. This API uses bearer token authentication via Laravel Sanctum.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'api/docs', 'api/docs/*', 'sanctum/*', 'telescope/*', 'admin/*'
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your API token by making a POST request to `/api/login` with your email and password. The token should be included in the Authorization header as `Bearer {token}`.',
    ],
