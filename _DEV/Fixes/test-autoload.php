...
if (! file_exists('vendor/autoload.php')) {
    exit("FAILED: vendor/autoload.php does not exist. Run 'composer install'\n");
}
...
if (! class_exists('Illuminate\Foundation\Application')) {
    exit("FAILED: Cannot load Illuminate\Foundation\Application\n");
}
echo "OK\n";
...
if (! class_exists('App\Providers\AppServiceProvider')) {
    exit("FAILED: Cannot load App\Providers\AppServiceProvider\n");
}
echo "OK\n";
