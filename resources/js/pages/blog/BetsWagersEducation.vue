    ...
    <WelcomeLayout>
        <div class="min-h-screen bg-gradient-to-b from-indigo-900 via-gray-900 to-black text-gray-200">
            <div class="container mx-auto px-4 py-16 max-w-3xl">
                <h1 class="text-4xl font-bold mb-8 text-white">Types of Bets and Wagers</h1>
                <img src="/images/blog/002-1.png" alt="Types of Bets and Wagers" class="mb-8 rounded shadow" />

                <h2 class="text-2xl font-semibold mt-8 mb-4 text-white">Most Common for US sports</h2>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Spread</h3>
                <p class="mb-4">
                    This is the ‘line’ that the bookies (Sportsbook) think most probably represents a 50/50 bet. In the box above, the New York Rangers are already losing by 2.0. So the line is +2.5, meaning if they lose by 2 or less, you would win your bet. Conversely, Tampa Bay are -2.5, so they must win by 3 scores or more for you to win this bet. The odds on a spread bet should be fairly close to the standard -110 if the spread is fair. (See odds explanation <a href="https://wewingames.com/betting-odds-explained/" class="text-indigo-400 underline" target="_blank">here</a>). The spread has different terms such as the Puck Line in hockey, the Run Line in baseball, etc. The objective is the same. It is the expected goal difference between the 2 teams to allow for an almost 50/50 bet. The Best Betting site will always have spreads included.
                </p>

                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Total or Over/Under</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Moneyline</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Futures</h3>
                <p class="mb-4">
                ...
                <h2 class="text-2xl font-semibold mt-10 mb-4 text-white">More Complicated Types of Wagers/Bets</h2>

                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Parlays</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Round Robins</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Pointsbetting</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">In-Play or live bets</h3>
                <p class="mb-4">
                    As it says, this is any form of bet made once the game has started. This is the fastest growing part of sports betting as the enjoyment of combining live bets while watching the action is the highest. All the Sportsbooks now offer them as standard, though service levels while placing a bet can be frustrating sometimes. The lines keep changing during the game, making it difficult to place the bet in time before the line moves again. In-Play betting can be very profitable, as the emotional overreaction to what happens on the pitch changes the odds too much. You can see good examples in our article on whether <a href="https://wewingames.com/can-betting-be-profitable/" class="text-indigo-400 underline" target="_blank">can betting be profitable</a>.
                </p>

                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Props</h3>
                <p class="mb-4">
                ...
                <h3 class="text-xl font-bold mt-6 mb-2 text-indigo-300">Teasers</h3>
                <p class="mb-4">
                ...
                <h2 class="text-2xl font-semibold mt-10 mb-4 text-white">Each-Way betting</h2>
                <p class="mb-4">
