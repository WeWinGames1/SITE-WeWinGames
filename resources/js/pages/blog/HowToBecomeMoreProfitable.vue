        ...
        <div class="min-h-screen bg-gradient-to-b from-indigo-900 via-gray-900 to-black text-gray-200">
            <div class="container mx-auto px-4 py-16 max-w-3xl">
                ...
                <ul class="list-disc list-inside mb-4 space-y-2">
                    ...
                    <li>Focus on value, not just winners. Look for bets where the odds are in your favor.</li>
                    <li>Keep detailed records of your bets to analyze what works and what doesn’t.</li>
                    <li>Specialize in a sport or league you know well to gain an edge over the sportsbook.</li>
                    <li>Shop for the best lines and odds across multiple sportsbooks.</li>
                    <li>Stay disciplined and avoid chasing losses with bigger bets.</li>
                    <li>Continue learning and adapting your strategies as the market evolves.</li>
                </ul>
