        ...
        <div class="min-vh-100" style="background: linear-gradient(180deg, #1a2332 0%, #0a1628 100%);">
            <div class="container-fluid px-4 px-lg-5 py-5">
                ...
                <div class="text-center mb-5 pt-5">
                    ...
                    <p class="fs-4 mb-4 text-primary">
                    ...
                    <p class="fs-5 text-gray-light mx-auto" style="max-width: 800px;">
                        When it comes to learning about sports betting it is hard to know who to trust. Often what may look like educational content is just a guise to funnel your attention to a sponsoring sportsbook. At <span class="fw-bold text-primary">We Win Games</span>, we believe a more knowledgeable sports bettor is good for everyone. It provides a richer and more sustainable market for all to enjoy.
                    </p>
                </div>
                        ...
                        <div v-for="post in posts" :key="post.id" class="col-12 col-md-6 col-lg-4">
                            <article class="card h-100" style="background-color: #1a2332; border: 1px solid #2e4057; transition: all 0.3s ease;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <!-- Excerpt -->
                                    <p class="text-gray-light small mb-4" style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">
                                        {{ post.excerpt }}
                                    </p>
