<template>
    <div>
        ...
        <div class="mb-4">
            ...
            >
                <input ref="fileInput" type="file" accept=".csv,.txt" @change="handleFileSelect" class="d-none" />
                ...
                <div v-if="!file">
                    ...
                    <button @click="$refs.fileInput.click()" class="btn btn-primary"><i class="bi bi-folder-open me-2"></i>Browse Files</button>
                </div>
                ...
                <div v-else>
                    ...
                    <button @click="removeFile" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash me-1"></i>Remove File</button>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <button @click="uploadFile" :disabled="!file || uploading" class="btn btn-primary">
                <span v-if="uploading">
                    <span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    Uploading...
                </span>
                <span v-else> Next: Map Columns <i class="bi bi-arrow-right ms-2"></i> </span>
            </button>
        </div>
    </div>
</template>
