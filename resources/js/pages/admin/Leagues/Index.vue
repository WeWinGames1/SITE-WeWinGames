...
watch(() => [filterForm.sport_id, filterForm.is_active], () => {
    applyFilters();
});
        ...
        <div class="container-fluid p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Manage leagues within each sport
                    </p>
                </div>
                <Link
            ...
            <div class="card">
                            ...
                            <tr v-for="league in leagues.data" :key="league.id">
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <Link
                                            :href="route('admin.leagues.edit', league.id)"
                ...
                <div v-if="leagues.data.length === 0" class="text-center py-5">
                    ...
                    <p class="text-muted">
                        Get started by adding your first league.
                    </p>
                    <Link
                        :href="route('admin.leagues.create')"
                ...
                <div v-if="leagues.last_page > 1" class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted small">
                            Showing {{ leagues.from }} to {{ leagues.to }} of {{ leagues.total }} results
                        </span>
                        <nav>
                            <ul class="pagination pagination-sm mb-0">
                                <li class="page-item" :class="{ disabled: leagues.current_page === 1 }">
                                    <Link
                                        :href="`?page=${leagues.current_page - 1}`"
                                        preserve-scroll
                                        class="page-link"
                                    >
                                        Previous
