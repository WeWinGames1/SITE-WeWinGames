...
const form = useForm({
    ...
    stake: 0,
    potential_win: 0,
    game_at: new Date().toISOString().slice(0, 16),
    status: 'pending',
    actual_result: '',
    is_featured: false,
    confidence: 5,
    ...
    <AdminLayout>
        ...
        <div class="p-6">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Create New Bet</h1>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-6">Additional Options</h2>
