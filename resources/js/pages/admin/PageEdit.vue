...
<template>
    <AppLayout :breadcrumbs="{ title: props.page ? 'Edit Page' : 'Create Page', href: route('admin.pages.index') }">
    <Head :title="props.page ? 'Edit Page' : 'Create Page'" />
    <div class="max-w-3xl mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4">{{ props.page ? 'Edit' : 'Create' }} Page</h1>
