...
<template>
    <div>
        ...
        <div class="row g-3 justify-content-center">
            <div v-for="plan in plans" :key="plan.name" class="col-lg-4">
                <div
                    :class="[
                ...
                >
                    ...
                    <div class="card-body d-flex flex-column p-4">
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-baseline mb-2 justify-content-center">
                                ...
                                <span class="text-muted ms-2"
                                    >/ {{ selectedPeriod === 'monthly' ? 'month' : selectedPeriod === 'weekly' ? 'week' : 'day' }}</span
                                >
                            </div>
                            <div class="text-center text-muted small">
                                ...
                                <span v-else-if="selectedPeriod === 'weekly'"> ${{ plan.monthlyPrice }}/month • ${{ plan.dailyPrice }}/day </span>
                                <span v-else> ${{ plan.monthlyPrice }}/month • ${{ plan.weeklyPrice }}/week </span>
                            </div>
                        </div>
                        ...
                        <ul class="list-unstyled mb-3 flex-grow-1">
                            <li
                                v-for="feature in selectedPeriod === 'monthly'
                                    ? plan.monthlyFeatures || plan.features
                                    : selectedPeriod === 'weekly'
                                      ? plan.weeklyFeatures || plan.features
                        ...
                        <div class="mt-auto">
                            <a
                                ...
                                :href="
                                    selectedPeriod === 'monthly' ? plan.monthlyLink : selectedPeriod === 'weekly' ? plan.weeklyLink : plan.dailyLink
                                "
