    ...
    <section class="py-5 bg-transparent testimonials-section">
        <div class="container">
            ...
            <div class="carousel-container position-relative">
                <!-- Navigation Buttons -->
                <button v-if="testimonials.length > 1" @click="slideToPrevious" class="carousel-nav carousel-nav-prev" :disabled="isTransitioning">
                    <i class="bi bi-chevron-left"></i>
                </button>

                <button v-if="testimonials.length > 1" @click="slideToNext" class="carousel-nav carousel-nav-next" :disabled="isTransitioning">
                                ...
                                <div class="card-body d-flex flex-column p-4">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="position-relative">
                                            ...
                                            <div
                                                class="position-absolute bottom-0 end-0 bg-success rounded-circle d-flex align-items-center justify-content-center"
...
const testimonials = computed(() => {
    const raw = props.testimonials && props.testimonials.length > 0 ? props.testimonials : defaultTestimonials;
