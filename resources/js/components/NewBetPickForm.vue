    ...
    <div class="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <form @submit.prevent="submitForm" enctype="multipart/form-data">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Sports -->
                <div>
                    <label for="sports" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >Sports <span class="text-red-500">*</span></label
                    >
                    <select
                        id="sports"
                        v-model="form.sports"
                ...
                <!-- League -->
                <div>
                    <label for="league" class="block text-sm font-medium text-gray-700 dark:text-gray-300">League</label>
                    <input
                        type="text"
                        id="league"
                        v-model="form.league"
                ...
                <!-- Matches -->
                <div>
                    <label for="matches" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Matches</label>
                    <input
                        type="text"
                        id="matches"
                ...
                <!-- Markets -->
                <div>
                    <label for="markets" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >Markets <span class="text-red-500">*</span></label
                    >
                    <input
                        type="text"
                        id="markets"
                ...
                <!-- Team One -->
                <div>
                    <label for="team_one" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Team One</label>
                    <input
                        type="text"
                        id="team_one"
                        v-model="form.team_one"
                        placeholder="e.g., Detroit Tigers"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                </div>
                <!-- Team One Logo -->
                ...
                <!-- Team Two -->
                <div>
                    <label for="team_two" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Team Two</label>
                    <input
                        type="text"
                        id="team_two"
                ...
                <!-- Wager Amount -->
                <div>
                    <label for="wager_amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Wager Amount</label>
                    <input
                        type="number"
                        id="wager_amount"
                        v-model="form.wager_amount"
                ...
                <!-- Betting Date -->
                <div>
                    <label for="betting_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Betting Date</label>
                    <input
                        type="date"
                        id="betting_date"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="tips"
                        v-model="form.tips"
                        placeholder="e.g., Astros to win"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                </div>
                <!-- Wager Odds -->
                <div>
                    <label for="wager_odds" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >Wager Odds <span class="text-red-500">*</span></label
                    >
                    <input
                        type="text"
                        id="wager_odds"
                ...
                <!-- Membership -->
                <div>
                    <label for="membership" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                        >Membership <span class="text-red-500">*</span></label
                    >
                    <select
                        id="membership"
