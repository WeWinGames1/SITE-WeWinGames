    ...
    <div class="card h-100 position-relative overflow-hidden" style="background-color: #1a2332; border: 2px solid #2a3441; border-radius: 12px">
        ...
        <div class="card-body p-4 position-relative" style="z-index: 2">
            ...
            <div class="d-flex flex-column flex-md-column align-items-center justify-content-center gap-2 mb-4">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <a
                        ...
                        class="btn btn-sm btn-primary opacity-50 d-md-none"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="btn btn-sm btn-primary opacity-50 d-none d-md-inline-block"
            ...
            <div class="text-center py-4">
                ...
                <Link :href="route('buy-our-picks')" class="btn btn-primary btn-lg px-5">
