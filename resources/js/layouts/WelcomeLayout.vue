...
<template>
    <div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="social-links d-flex gap-2">
                            <a :href="socialMediaLinks.facebook" target="_blank" rel="noopener" class="text-white opacity-75"
                                ><i class="bi bi-facebook"></i
                            ></a>
                            <a :href="socialMediaLinks.instagram" target="_blank" rel="noopener" class="text-white opacity-75"
            ...
            <div class="container-fluid px-4 px-lg-5">
                ...
                <Link href="/" class="navbar-brand d-flex align-items-center">
                    ...
                    <div class="d-none d-lg-block ms-2">
                        <div class="text-white fw-medium" style="font-size: 0.85rem; line-height: 1.2; letter-spacing: 0.5px">
                            We make sports betting easy
                        </div>
                    </div>
                </Link>
                ...
                <div class="collapse navbar-collapse" :class="{ show: mobileMenuOpen }" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item" v-for="link in navLinks" :key="link.title">
                            <Link :href="link.href" class="nav-link text-light" @click="mobileMenuOpen = false">
                                {{ link.title }}
                            </Link>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li v-for="link in dropdownLinks" :key="link.title">
                                    <Link :href="link.href" class="dropdown-item" @click="mobileMenuOpen = false">
                                        {{ link.title }}
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item ms-lg-3" v-if="!auth.user">
                            <Link href="/login" class="btn btn-sm btn-outline-light px-3 py-2" style="border-radius: 20px; font-size: 14px"
                                >Login</Link
                            >
                        </li>
                        ...
                        <li class="nav-item dropdown ms-lg-3" v-else>
                            ...
                            >
                                <div class="d-flex align-items-center">
                                    <div
                                        class="rounded-circle bg-warning d-flex align-items-center justify-content-center me-2"
                            ...
                            <ul
                                ...
                                style="background-color: var(--bs-gray-dark); border: 1px solid var(--bs-gray-medium); min-width: 220px"
                            >
                                ...
                                <li>
                                    <Link href="/dashboard" class="dropdown-item text-light"
                                        ><i class="bi bi-speedometer2 me-2 text-warning"></i>Dashboard</Link
                                    >
                                </li>
                                <li>
                                    <Link href="/todays-bets" class="dropdown-item text-light"
                                        ><i class="bi bi-lightbulb me-2 text-warning"></i>Today's Tips</Link
                                    >
                                </li>
                                <li>
                                    <Link href="/settings/profile" class="dropdown-item text-light"
                                        ><i class="bi bi-gear me-2 text-warning"></i>Settings</Link
                                    >
                                </li>
                                <li>
                                    <Link href="/settings/billing" class="dropdown-item text-light"
                                        ><i class="bi bi-credit-card me-2 text-warning"></i>Billing</Link
                                    >
                                </li>
                                <li>
                                    <Link href="/support/tickets" class="dropdown-item text-light"
                                        ><i class="bi bi-headset me-2 text-warning"></i>Support</Link
                                    >
                                </li>
                                ...
                                <li v-if="auth.user.data.is_admin">
                                    <Link href="/admin" class="dropdown-item text-light"
                                        ><i class="bi bi-speedometer2 me-2 text-warning"></i>Admin Dashboard</Link
                                    >
                                </li>
            ...
            <section v-if="!isOnFaqPage" id="faq" class="py-5 position-relative">
                <div class="container-fluid px-4 px-lg-5">
                    <div class="position-relative">
                        ...
                        <img
                            src="/images/footer-faq-icon.png"
                            alt="FAQ"
                            class="position-absolute"
                            style="height: 120px; right: 0; top: -20px; z-index: 10"
                        />
                ...
                <div class="container-fluid px-4 px-lg-5">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            ...
                            <p class="text-white mb-0" style="font-size: 14px; line-height: 1.6">
                        ...
                        <div class="col-lg-8">
                            <div
                                class="d-flex align-items-center p-2 rounded mb-3"
                                style="background-color: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 193, 7, 0.3); width: fit-content"
                            >
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-4 mb-2 mb-md-0">
                            ...
                            <div class="social-links d-flex gap-3">
                                <a :href="socialMediaLinks.facebook" target="_blank" rel="noopener" class="text-secondary"
                                    ><i class="bi bi-facebook"></i
                                ></a>
                                <a :href="socialMediaLinks.instagram" target="_blank" rel="noopener" class="text-secondary"
                                    ><i class="bi bi-instagram"></i
                                ></a>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="text-secondary small">© Copyright {{ new Date().getFullYear() }} We Win Games. All Right Reserved.</div>
        ...
        <KnowledgebaseSidebar v-if="isAdmin" :isVisible="knowledgebaseSidebarOpen" @close="knowledgebaseSidebarOpen = false" />
    </div>
</template>
