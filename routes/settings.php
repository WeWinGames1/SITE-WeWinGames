...
use App\Http\Controllers\Settings\BettingPreferencesController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('settings/betting-preferences', [BettingPreferencesController::class, 'edit'])->name('betting-preferences.edit');
    Route::patch('settings/betting-preferences', [BettingPreferencesController::class, 'update'])->name('betting-preferences.update');
