    ...
    public function run(): void
    {
        ...
        EmailTemplate::updateOrCreate(
            ...
            [
                ...
                'body_html' => '<h2>Welcome to {{plan_name}}!</h2><p>Hi {{user_name}},</p><p>Thank you for subscribing to {{app_name}}! Your {{plan_name}} subscription is now active.</p><p><strong>What\'s included:</strong></p><ul><li>Access to all premium betting picks</li><li>Expert analysis and insights</li><li>Real-time notifications</li><li>Exclusive member content</li></ul><p><a href="{{dashboard_url}}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Go to Dashboard</a></p><hr style="margin: 30px 0; border: none; border-top: 1px solid #eee;"><h3 style="color: #5865f2;">Join Our Discord Community!</h3><p>As a subscriber, you get exclusive access to our Discord community with member-only channels, real-time alerts, and direct access to our experts.</p><p><a href="{{dashboard_url}}" style="background-color: #5865f2; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Connect Discord</a></p><p>If you have any questions, our support team is here to help!</p><p>Best regards,<br>The {{app_name}} Team</p>',
